...
/* package florin-0.1.0.0 */
#ifndef VERSION_florin
#define VERSION_florin "0.1.0.0"
#endif /* VERSION_florin */
#ifndef MIN_VERSION_florin
#define MIN_VERSION_florin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_florin */
...
/* package inline-c-0.9.1.6 */
#ifndef VERSION_inline_c
#define VERSION_inline_c "0.9.1.6"
...
#define CURRENT_COMPONENT_ID "florin-0.1.0.0-5kIGUMTniNQI5qjfCzcCKi-florin"
